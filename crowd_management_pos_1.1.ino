...
void loop()
{
  ...
  if ((po_a == 1 || po_b == 1) && (ppl_a != 10 || ppl_b != 10))
  {

    // if(pi_a==1){ppl_a--;delay(500);}
    // if(po_a==1){ppl_a++;delay(500);}
    // if(pi_b==1){ppl_b--;delay(500);}
    // if(po_b==1){ppl_b++;delay(500);}
    // if(ppl_a<=ppl_b){
  ...
  // if(ppl_a>=10 && ppl_b>=10 && (po_a==1 || po_b==1)){
  // if(ppl_c<10){Serial.println("Crowd detected, opening terminal C: ");}
  // if(pi_c==1){
  //     ppl_c--;
  // }
}
